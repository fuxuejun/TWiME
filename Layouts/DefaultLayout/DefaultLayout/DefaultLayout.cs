...
namespace TWiME {
    internal class DefaultLayout : Layout, ILayout {
        ...
        public DefaultLayout(List<Window> windowList, Rectangle area, TagScreen parent) {
            ...
            splitter = Manager.Settings.ReadSettingOrDefault(0.5f, parent.parent.Screen.DeviceName.Replace(".", "").Replace("\\", ""),
                parent.tag.ToString(), "Splitter");
            vsplitter = Manager.Settings.ReadSettingOrDefault(0.5f, parent.parent.Screen.DeviceName.Replace(".", "").Replace("\\", ""),
